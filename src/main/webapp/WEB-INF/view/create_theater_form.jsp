            ...
            function addTheater() {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        window.location.replace("http://localhost:1212/movie/theaters");
                        return ;
                    },
                    error: function (e) {
    ...
    <body>
                ...
                <div class="col-md-7 offset-md-3">
                    ...
                    <form class="button">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control city-field" id="city" name="city"
                        ...
                        <div class="center-button">
                            ...
                            <button class="btn" id="submitButton" type="button"
                                style="padding: 5px 10px 5px 10px;border-radius: 5px;" onclick="return showConfirmationDialog()">
                                Submit
                            </button>
                        </div>
                    </form>
        ...
        <script>
            ...
            function showConfirmationDialog() {
                ...
                confirmationMessage += "Theater Name: " + name + "\n";
                confirmationMessage += "City Name: " + city + "\n";
