        ...
        <script>
            ...
            function populateInvoiceTable(invoices) {
                ...
                $.each(invoices, function (index, invoice) {
                    ...
                    row.append($('<td>').text(invoice.show.theater.theaterName));
                    row.append($('<td>').text(invoice.show.theater.city));
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <form>
                        ...
                        <button href="home" class="btn  center-button" type="submit">Back Home</button>
